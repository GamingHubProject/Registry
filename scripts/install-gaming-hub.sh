...
install_gaming_hub() {
    ...
    # DatabaseSeeder creates roles, permissions, capabilities, and the
    # admin@local / local account in one pass — no separate admin-creation
    # step needed on a fresh install.
